 ...
 *
 * @package DwContentElements\Domain\Model;
 */
class Category extends \TYPO3\CMS\Extbase\Domain\Model\Category {
	 ...
	 *
	 * @lazy
	 * @var \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Denkwerk\DwContentElements\Domain\Model\Category>
	 */
	 ...
	 * Adds a category
	 *
	 * @param \Denkwerk\DwContentElements\Domain\Model\Category $category
	 * @return void
	 */
	public function addSubCategory(\Denkwerk\DwContentElements\Domain\Model\Category $category) {
	 ...
	 * @return void
	 */
	public function removeSubCategory(\Denkwerk\DwContentElements\Domain\Model\Category $category) {

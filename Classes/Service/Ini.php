...
class Ini
{
    ...
    public function loadConfig()
    {
        ...
        $this->configFileAbsPath = \Denkwerk\DwContentElements\Utility\Pathes::concat(
            array(
                realpath(PATH_site),
        ...
        if (is_file($this->configFileAbsPath) === true) {
             ...
             */
            $tsParser = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(
                'Denkwerk\\DwContentElements\\Utility\\TypoScriptParser'
            );

...
class Div
{
     ...
     * @param bool $pad Switch for allowing padding.
     * Fills the combined array with empty values if any array is larger than the other one.
